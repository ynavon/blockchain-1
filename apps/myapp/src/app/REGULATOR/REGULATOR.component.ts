...
export class REGULATORComponent implements OnInit {
  ...
  REGULATORaddress = new FormControl('', Validators.required);
  ...
  constructor(public serviceREGULATOR: REGULATORService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      REGULATORaddress: this.REGULATORaddress
    });
  };
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.kosher.poc.REGULATOR',
      'REGULATORId': this.REGULATORId.value,
      'REGULATORName': this.REGULATORName.value,
      'REGULATORaddress': this.REGULATORaddress.value
    };
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.REGULATORaddress) {
        formObject.REGULATORaddress = result.REGULATORaddress;
      } else {
        formObject.REGULATORaddress = null;
      }
